if (SERVER) then
    ...
    RAS.Config.Chat.Players = {}
    RAS.Config.Prop.Players = {}
    RAS.Config.Effect.Players = {}
    RAS.Config.Ragdoll.Players = {}
    RAS.Config.Vehicle.Players = {}
    RAS.Config.Npc.Players = {}
    RAS.Config.Sent.Players = {}
